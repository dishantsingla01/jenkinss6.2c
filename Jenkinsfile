pipeline {
    ...
    environment {
        EMAIL_RECIPIENT = 'dishantsingla51@gmail.com' // Email for security scan and other important notifications
        USER_EMAIL = 'disahntsingla51@gmail.com' // User email to receive step completion notifications
    }
